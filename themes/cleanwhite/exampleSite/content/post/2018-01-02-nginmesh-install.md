...
```
想要了解更多关于如何从集群外部进行访问的内容，可以参考[如何从外部访问Kubernetes集群中的应用？](http://lengxuan.com/2017/11/28/access-application-from-outside/)
...
[Istio及Bookinfo示例程序安装试用笔记](http://lengxuan.com/2017/11/04/istio-install_and_example/)
